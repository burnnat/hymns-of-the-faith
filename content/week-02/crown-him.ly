...
\header
{
  ...
  tagline = ##f
  poet = \markup{ \italic Text: Matthew Bridges 1851; st. 4, Godfrey Thring, 1874 }
  composer = \markup{ \italic Tune: George Job Elvey, 1868 }
}
...
\score
{
  <<
    ...
    \context Lyrics = sopranosSix \lyricsto sopranos \verseSix
  >>
